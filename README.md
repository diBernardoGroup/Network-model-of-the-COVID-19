...
3.  test_factor: this is a multiplier for the alpha parameter common to all the regions. Leave it to 1 to use the identified alpha (we recommend to not exceed the value 3);
4.  rho_factor: this is a reduction factor for the maximum admissible rho value. Leave it to 1 to use the identified rho;
